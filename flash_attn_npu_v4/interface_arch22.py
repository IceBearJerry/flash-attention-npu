...
import flash_attn_npu_arch22_v4 # Registers operators with PyTorch
...
@_torch_custom_op_wrapper("flash_attn_npu_arch22_v4::_flash_attn_forward", mutates_args=(), device_types="npu")
def _flash_attn_forward(
    ...
    out, softmax_lse = flash_attn_npu_arch22_v4.fwd(
        q,
        k,
        v,
        qv,
