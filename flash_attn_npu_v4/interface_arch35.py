...
# isort: off
import flash_attn_npu_arch35_v4
# isort: on
...
@_torch_custom_op_wrapper(
    "flash_attn_npu_arch35_v4_C::_flash_attn_forward", mutates_args=(), device_types="npu"
)
...
def _flash_attn_forward(
    ...
    out_t, softmax_lse, out_accum, softmax_lse_accum = flash_attn_npu_arch35_v4.fwd(
        q, k, v,
        qv, out_,
        cu_seqlens_q, cu_seqlens_k,
        seqused_q, seqused_k,
